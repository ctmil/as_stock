...
class as_stock_move(osv.osv):
	...
	def init(self, cr):
			...
			create view as_stock_move as 
				...
				union
				select a.id as id*1000,a.picking_id as picking_id,a.date,a.company_id as company_id,a.product_id as product_id,a.location_id as location_id,b.usage as location_usage,
					a.location_dest_id as location_dest_id,c.usage as location_dest_usage,a.product_uom_qty as product_uom_qty,
					...
					and a.location_id <> a.location_dest_id
				union
				select a.id as id*10000,a.picking_id as picking_id,a.date,a.company_id as company_id,a.product_id as product_id,a.location_id as location_id,b.usage as location_usage,
					a.location_dest_id as location_dest_id,c.usage as location_dest_usage,a.product_uom_qty as product_uom_qty,
